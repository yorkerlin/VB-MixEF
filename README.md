For an efficient MOG implementaiton using vectorization（which is 20 times faster than this repo), please use new [repo](https://github.com/yorkerlin/iBayesLRule) based on our ICML 2020 paper.
